    ...
    <div class="relative bg-gradient-to-r from-[#7F9ED2] to-[#8ED3D8] py-20 text-center text-white overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <p class="text-white/95 max-w-3xl mx-auto text-base md:text-lg font-light leading-relaxed font-sans">
                Kami hadir untuk membantu wisatawan menemukan pengalaman terbaik di Banyuwangi melalui teknologi dan rekomendasi cerdas.
            </p>
        </div>
        <!-- Wave SVG -->
        <div class="absolute bottom-0 left-0 right-0 w-full overflow-hidden leading-none z-0">
            <svg viewBox="0 0 1200 120" preserveAspectRatio="none" class="relative block w-full h-[50px] text-white fill-current">
    ...
    <div class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex justify-center mb-10">
                <img class="max-w-[750px] w-full h-auto object-contain" src="{{ asset('images/logo-about.png') }}" alt="Laras Banyuwangi Logo">
            </div>

            <!-- Title: Siapa Kami? -->
            <div class="text-center mb-16">
                <h2 class="text-4xl md:text-[2.75rem] font-bold font-sans tracking-tight">
                    <span class="text-[#3F5C7D]">Siapa</span> <span class="bg-gradient-to-r from-[#89A8E0] to-[#8ED3D8] bg-clip-text text-transparent">Kami?</span>
                </h2>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch mb-20">
                ...
                <div class="col-span-12 lg:col-span-5 p-8 rounded-[2rem] bg-white border border-slate-100 shadow-[0_12px_28px_rgba(0,0,0,0.03)] hover:shadow-lg transition-shadow flex flex-col justify-center">
                    <h3 class="text-2xl md:text-3xl font-bold text-[#3F5C7D] mb-1 font-sans leading-tight">Mengenal Lebih Dekat</h3>
                    <h2 class="text-xl md:text-4xl font-bold mb-6 font-sans"><span class="bg-gradient-to-r from-[#89A8E0] to-[#8ED3D8] bg-clip-text text-transparent">Laras Banyuwangi</span></h2>
                    <p class="text-slate-600 font-sans text-xs leading-relaxed text-sm md:text-base mb-4">
                        "Laras" dalam budaya lokal bermakna keselarasan. Kami percaya bahwa pariwisata sejati bukan sekadar mengunjungi tempat, melainkan sebuah dialog antara pengunjung, masyarakat lokal, dan kelestarian alam.
                    </p>
                    <p class="text-slate-600 font-sans text-xs leading-relaxed text-sm md:text-base">
                        Berawal dari kecintaan terhadap keindahan Banyuwangi yang belum sepenuhnya terekspos, kami mendedikasikan platform ini sebagai jembatan bagi para penjelajah untuk menemukan esensi sesungguhnya dari 'The Sunrise of Java'.
                    </p>
                </div>
