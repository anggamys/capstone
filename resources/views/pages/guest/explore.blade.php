<x-guest-portal-layout>
    <x-slot name="title font-sans">Jelajah Wisata - Laras Banyuwangi</x-slot>
    ...
    <div class="py-16 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white p-12 rounded-3xl border border-slate-100 shadow-sm text-center">
                <p class="text-slate-500 font-sans">Halaman Jelajah Destinasi sedang dalam proses pengembangan.</p>
            </div>
        </div>
    </div>
</x-guest-portal-layout>
