<x-app-layout>
    <x-slot name="header">
        {{ __('Destinasi Wisata | Edit') }}
    </x-slot>

    <div class="py-2">
        <form action="{{ route('admin.destinasi.update', $destination->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                <div>
                    <h1 class="text-2xl font-bold text-[#2B3674]">Edit Destinasi</h1>
                    <p class="text-sm text-slate-400 mt-1 font-medium">Ubah informasi destinasi wisata yang ada di sistem</p>
                </div>
                <div>
            ...
            <div class="bg-white rounded-3xl p-8 shadow-sm border border-indigo-100/10 mb-6">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <x-select-input 
                                ...
                                :value="old('destination_category_id', $destination->destination_category_id)"
                        ...
                        <div>
                            ...
                            <x-select-input 
                                ...
                                :value="old('destination_subcategory_id', $destination->destination_subcategory_id)"
                    ...
                    <div>
                        ...
                        >{{ old('description', $destination->description) }}</x-form-textarea>
                        @error('description')
                            <p class="text-xs text-rose-500 font-semibold mt-1.5 ml-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <x-select-input 
                            name="status"
                            :value="old('status', $destination->status)"
            ...
            <div class="bg-white rounded-3xl p-8 shadow-sm border border-indigo-100/10 mb-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-select-input 
                            name="district"
                            :value="old('district', $destination->district)"
                            :options="$districts"
            ...
            <div class="bg-white rounded-3xl p-8 shadow-sm border border-indigo-100/10 mb-6">
                ...
                <div class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <x-form-input 
                                   ...
                                   value="{{ old('visit_duration_hours', $destination->visit_duration_hours) }}" 
                    ...
                    <div>
                        ...
                        <x-select-input 
                            name="access_level"
                            :value="old('access_level', $destination->access_level)"
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-3">
                            @php
                                $selectedActivities = old('activities', $destination->activities->pluck('id')->toArray());
                            @endphp
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-3">
                            @php
                                $selectedFacilities = old('facilities', $destination->facilities->pluck('id')->toArray());
                            @endphp
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-3">
                            @php
                                $selectedTravelTypes = old('travel_types', $destination->travelTypes->pluck('id')->toArray());
                            @endphp
                            @foreach($travelTypes as $type)
                                <x-form-checkbox-pill 
                                    ...
                                    :value="$type->id"
                                    :label="$type->name"
                                    :checked="in_array($type->id, $selectedTravelTypes)"
                                />
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-3">
                            @php
                                $selectedVisitTimes = old('visit_times', $destination->visitTimes->pluck('id')->toArray());
                            @endphp
                            @foreach($visitTimes as $time)
                                <x-form-checkbox-pill 
                                    ...
                                    :value="$time->id"
                                    :label="$time->name"
                                    :checked="in_array($time->id, $selectedVisitTimes)"
                                />
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-3">
                            @php
                                $selectedTransportations = old('transportations', $destination->transportations->pluck('id')->toArray());
                            @endphp
                            @foreach($transportations as $transport)
                                <x-form-checkbox-pill 
                                    ...
                                    :checked="in_array($transport->id, $selectedTransportations)"
                                />
                            @endforeach
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Watch for custom select value changes using polling
            setInterval(collectTags, 800);
        });
    </script>
</x-app-layout>
