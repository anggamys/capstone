<x-app-layout>
    ...
    <div class="py-2">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            <div>
                <h1 class="text-2xl font-bold text-[#2B3674]">Detail Transportasi</h1>
                <p class="text-sm text-slate-400 mt-1 font-medium">Lihat rincian informasi transportasi tersebut</p>
            </div>
            <div>
        ...
        <div class="bg-white rounded-3xl p-8 shadow-sm border border-indigo-100/10 mb-6">
            ...
            <div class="flex items-center gap-3 mb-8 border-b border-slate-100 pb-4">
                ...
                <h2 class="text-base font-bold text-[#2B3674]">Informasi Transportasi</h2>
            </div>

            <div class="space-y-6">
                <!-- Display 1: Nama Transportasi -->
                <div>
                    <label class="block text-sm font-bold text-[#2B3674] mb-2">Nama Transportasi</label>
                    <input type="text" 
                ...
                <!-- Display 2: Slug -->
                <div>
                    <label class="block text-sm font-bold text-[#2B3674] mb-2">Slug Transportasi</label>
                    <input type="text" 
                           value="{{ $transportation->slug }}" 
                           disabled 
                ...
                <div>
                    ...
                    <input type="text" 
                           value="{{ $transportation->status === 'active' ? 'Aktif' : 'Tidak Aktif' }}" 
                           disabled 
                           class="w-full px-5 py-4 bg-[#F4F7FE]/60 text-slate-500 rounded-2xl border-none text-sm font-semibold cursor-not-allowed">
                </div>
            </div>
