<x-app-layout>
    <x-slot name="header">
        {{ __('Transportasi | Tambah') }}
    </x-slot>

    <div class="py-2">
        <form action="{{ route('admin.transportasi.store') }}" method="POST">
            @csrf
            
            <!-- Header Title & Action Section -->
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                <div>
                    <h1 class="text-2xl font-bold text-[#2B3674]">Tambah Transportasi Baru</h1>
                    <p class="text-sm text-slate-400 mt-1 font-medium">Lengkapi informasi untuk menambah transportasi baru</p>
                </div>
                <div>
