<x-app-layout>
    <x-slot name="header">
        {{ __('Kategori Destinasi | Edit') }}
    </x-slot>

    <div class="py-2">
        <form action="{{ route('admin.kategori-destinasi.update', $category->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                <div>
                    <h1 class="text-2xl font-bold text-[#2B3674]">Edit Kategori Destinasi</h1>
                    <p class="text-sm text-slate-400 mt-1 font-medium">Ubah informasi untuk kategori destinasi tersebut</p>
                </div>
                <div>
