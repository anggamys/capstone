                ...
                <tr class="hover:bg-slate-50/50 transition-colors duration-150">
                    ...
                    <td class="px-8 py-5 text-sm w-44">
                        <div class="flex items-center gap-4 text-[#89A8E0]">
                            ...
                            <a href="javascript:void(0)" onclick="alert('Fitur detail kategori akan diintegrasikan nanti.')" class="hover:text-[#3F5C7D] transition-colors duration-150" title="Detail">
                            ...
                            <a href="javascript:void(0)" onclick="alert('Fitur edit kategori akan diintegrasikan nanti.')" class="hover:text-amber-600 transition-colors duration-150 text-amber-500" title="Edit">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
                            ...
                            <button type="button" onclick="if(confirm('Apakah Anda yakin ingin menghapus kategori ini?')) { alert('Fitur hapus kategori akan diintegrasikan nanti.'); }" class="hover:text-rose-600 transition-colors duration-150 text-rose-500 align-middle" title="Hapus">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
